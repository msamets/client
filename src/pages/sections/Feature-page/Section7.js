                    ...
                    <div className="col-12">
                        <div className='content_sec_4'>
                            <div className="security_en">
                                ...
                                <p className='text-center px-3'>Choose cloud-hosted or self-hosted control planes, both with full end-to-end encryption. Only configuration data flows over the network; your actual datasets and VM contents remain private.</p>
                            </div>
