    ...
    return(
        <section id="featureSec4" className="container-fluid pt-5 pb-5 mt-100">  
         ...
         <div className="col-md-6">
                <img src={Service2} alt="feature 3" />
                </div>
            <div className="col-md-6">
                <h3 className="font-40">Professional Services & Expert Support</h3>
                <p className="dev_sec1">Whether you’re deploying AI inferencing in containers or launching high-performance VMs for big data processing, our Software-Defined Network seamlessly connects workloads within and across regions.</p>
                <div className='row'>
